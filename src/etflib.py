...
class TweetFilter(object):
    ...
    def etf_user_timeline_extract_apiv2(self, user_id, user_input):
        ...
        for page in paginator:
            ...
            if num_tweets == 0:
                ...
                users_df.drop(users_df[(users_df[user_id_column] == user_id)].index, inplace=True)
                continue
    ...
    def etf_add_extract_columns(self, users_input):
