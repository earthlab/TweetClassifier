...
def main():
    ...
    ensemble_model_v2_1 = model1.load_state_dict(torch.load(ensemble_model_file_v2_1, map_location=torch.device('cpu')))
    ensemble_model_v2_2 = model2.load_state_dict(torch.load(ensemble_model_file_v2_2, map_location=torch.device('cpu')))
